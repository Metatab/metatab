...
class TestBuilder(unittest.TestCase):
    ...
    def test_basic(self):
        ...
        root.new_term('Declare','/Volumes/Storage/proj/virt/ambry/metatab-py/test-data/census.csv')
        ...
        root_doc.write_csv('/tmp/acs20145-metadata.csv')
        ...
        src_doc.write_csv('/tmp/acs20145-sources.csv')
        ...
        sch_doc.write_csv("/tmp/acs20145-schema.csv")
